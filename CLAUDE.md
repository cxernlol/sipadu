...
**Note on Scraping**: The data scraping engine has been rewritten from Node.js (Puppeteer) to **Rust** (`scraper_rs/`). Do not attempt to use Node.js/Python for scraping. See `AGENTS.md` for details.
