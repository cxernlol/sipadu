  ...
  return (
    <div className="min-h-screen bg-[#f8f8fa] relative overflow-hidden">
      ...
      <div className="fixed inset-0 -z-10">
        <div className="absolute top-1/4 left-1/3 w-[500px] h-[500px] bg-blue-200/25 rounded-full blur-[128px] animate-pulse" />
      ...
      <main className="flex-1 flex items-center justify-center min-h-[calc(100vh-73px)]">
        <AnimateIn className="text-center max-w-2xl px-6 flex flex-col items-center">
          {/* University badge */}
          <div className="inline-flex items-center gap-2.5 bg-white px-5 py-2.5 rounded-full text-sm font-medium text-blue-800 border border-blue-200 shadow-sm mb-10">
            <img src="https://upload.wikimedia.org/wikipedia/commons/b/b3/Lambang_UGM.svg" alt="UGM" className="h-5 w-5 object-contain" />
            Universitas Gadjah Mada
          </div>

          {/* Construction icon */}
          <div className="h-24 w-24 rounded-3xl bg-blue-50 border border-blue-100 flex items-center justify-center mb-10">
