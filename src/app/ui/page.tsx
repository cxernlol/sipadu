  ...
  return (
    <div className="min-h-[80vh] flex flex-col items-center justify-center py-20 px-4">
      <AnimateIn className="text-center max-w-2xl flex flex-col items-center">
        <div className="inline-flex items-center gap-2 bg-yellow-50 px-4 py-1.5 rounded-full text-sm font-medium text-yellow-600 border border-yellow-200 shadow-sm mb-8">
        ...
        <h1 className="font-serif text-4xl md:text-5xl leading-tight mb-6 text-slate-900">
          Sistem informasi dalam <br/><span className="text-yellow-600">tahap pengembangan.</span>
        </h1>
        
        <p className="text-lg text-slate-500 mb-10">
          Kami sedang memetakan sistem informasi dan sumber data untuk mahasiswa Universitas Indonesia. Fitur ini akan segera tersedia!
        </p>
