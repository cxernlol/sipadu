  ...
  return (
    <div className="min-h-screen bg-[#f8f8fa] dark:bg-black relative overflow-hidden">
      ...
      <div className="fixed inset-0 -z-10">
        <div className="absolute top-1/4 left-1/3 w-[500px] h-[500px] bg-amber-200/25 dark:bg-amber-900/20 rounded-full blur-[128px] animate-pulse" />
        <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] bg-yellow-200/20 dark:bg-yellow-900/10 rounded-full blur-[128px] animate-pulse [animation-delay:2s]" />
      ...
      <main className="flex-1 flex items-center justify-center min-h-[calc(100vh-73px)]">
        <AnimateIn className="text-center max-w-2xl px-6 flex flex-col items-center">
          {/* University badge */}
          <div className="inline-flex items-center gap-2.5 bg-white dark:bg-zinc-900 px-5 py-2.5 rounded-full text-sm font-medium text-amber-700 dark:text-amber-400 border border-amber-200 dark:border-amber-800 shadow-sm mb-10">
          ...
          {/* Construction icon */}
          <div className="h-24 w-24 rounded-3xl bg-amber-50 dark:bg-amber-900/30 border border-amber-100 dark:border-amber-800 flex items-center justify-center mb-10">
