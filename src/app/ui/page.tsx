  ...
  return (
    <div className="min-h-screen bg-[#f8f8fa] relative overflow-hidden">
      ...
      <div className="fixed inset-0 -z-10">
        <div className="absolute top-1/4 left-1/3 w-[500px] h-[500px] bg-amber-200/25 rounded-full blur-[128px] animate-pulse" />
        <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] bg-yellow-200/20 rounded-full blur-[128px] animate-pulse [animation-delay:2s]" />
      ...
      <main className="flex-1 flex items-center justify-center min-h-[calc(100vh-73px)]">
        <AnimateIn className="text-center max-w-2xl px-6 flex flex-col items-center">
          {/* University badge */}
          <div className="inline-flex items-center gap-2.5 bg-white px-5 py-2.5 rounded-full text-sm font-medium text-amber-700 border border-amber-200 shadow-sm mb-10">
            <img src="https://upload.wikimedia.org/wikipedia/commons/9/9a/Universitas_Indonesia_logo.svg" alt="UI" className="h-5 w-5 object-contain" />
            Universitas Indonesia
          </div>

          {/* Construction icon */}
          <div className="h-24 w-24 rounded-3xl bg-amber-50 border border-amber-100 flex items-center justify-center mb-10">
            <i className="fa-solid fa-helmet-safety text-4xl text-amber-400" />
          </div>

          <h1 className="text-4xl md:text-5xl font-bold tracking-tight leading-tight mb-6 text-slate-900">
            Portal sedang dalam<br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-500 to-yellow-500">tahap pengembangan.</span>
          </h1>

          <p className="text-lg text-slate-400 mb-10 leading-relaxed font-light max-w-lg">
            Tim engineering kami sedang memetakan dan mengintegrasikan sistem informasi Universitas Indonesia ke dalam jaringan SiPadu.
          </p>
          ...
          <div className="flex gap-6 mb-12">
            ...
            <div className="flex flex-col items-center gap-2">
              <div className="h-10 w-10 rounded-xl bg-blue-50 border border-blue-200 flex items-center justify-center animate-pulse">
                <i className="fa-solid fa-code text-blue-500 text-sm" />
              </div>
              <span className="text-xs text-blue-600 font-medium">Integrasi</span>
            </div>
            <div className="flex flex-col items-center gap-2">
